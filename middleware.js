...
export default function middleware(request) {
  ...
  if (
    !credentials ||
    !timingSafeEqual(credentials.username.trim(), username) ||
    !timingSafeEqual(credentials.password.trim(), password)
  ) {
    return unauthorized();
  }
...
export const config = {
  matcher: ["/salottidea/:path*", "/area_clienti_social/:path*", "/api/meta-insights"],
};
